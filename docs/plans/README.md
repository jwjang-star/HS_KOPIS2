...
| 2 | 전국 축제 연동(백엔드) — 전국문화축제표준데이터 | ✅ 구현+검증 완료, **배포는 아직 안 함** (2026-08-05) |
| 3 | UI 통합 (리스트 상단 "공연\|축제" 탭 + 지도 보조마커) | ✅ 구현+브라우저 검증 완료, **배포는 아직 안 함** (2026-08-05) |

## 문서 목록

- [01-holiday-integration.md](./01-holiday-integration.md) — Phase 1 상세 설계·구현·검증 기록 (완료)
- [02-festival-integration.md](./02-festival-integration.md) — Phase 2+3 상세 설계·구현·검증 기록 (백엔드+UI 완료, 배포 전)
