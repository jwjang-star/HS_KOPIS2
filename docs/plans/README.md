...
| 4 | 캘린더 대시보드 (최상위 탭으로 지도·리스트 뷰와 전환, 공연+축제+공휴일을 한 달력에) | 🔧 구현 + 날짜 리스트 2단화 + 로컬 검증 완료 (2026-09-03), **프로덕션 미배포 — 배포 승인 대기** |
...
- [04-calendar-dashboard.md](./04-calendar-dashboard.md) — Phase 4 캘린더 대시보드 설계 + 구현 결과 (날짜 리스트 2단화까지 완료, 로컬 검증됨, 배포 대기)
