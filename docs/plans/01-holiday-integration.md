...
**상태: 완료 (구현+검증+배포+프로덕션 실데이터 확인까지 전부 완료, 2026-08-05)**

Render 환경변수 등록 과정에서 겪은 문제(이중 인코딩, 줄바꿈 혼입)와 해결법은 [03-render-env-var-incident.md](./03-render-env-var-incident.md) 참고.
